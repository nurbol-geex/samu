...
export type SegmentEvent = TrackEventType | ScreenEventType | IdentifyEventType | GroupEventType | AliasEventType;
...
export type DeepPartial<T> = {
    [Property in keyof T]?: Property extends object ? DeepPartial<T[Property]> : Partial<T[Property]>;
};
...
export type IntegrationSettings = SegmentAPIIntegration<SegmentAmplitudeIntegration> | SegmentAPIIntegration<SegmentAdjustSettings> | Record<string, unknown> | boolean;
