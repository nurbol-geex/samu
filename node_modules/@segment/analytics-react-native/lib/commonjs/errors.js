...
exports.translateHTTPError = exports.checkResponseForErrors = exports.SegmentError = exports.NetworkError = exports.JSONError = exports.ErrorType = void 0;
/**
...
class JSONError extends SegmentError {
  constructor(type, message, innerError) {
    super(type, message, innerError);
...
const translateHTTPError = error => {
...
exports.translateHTTPError = translateHTTPError;
