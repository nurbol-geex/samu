...
export function createMockStoreGetter(fn) {
...
export class MockSegmentStore {
  ...
  callbacks = {
    context: createCallbackManager(),
    settings: createCallbackManager(),
    ...
    pendingEvents: createCallbackManager()
  };
  isReady = {
