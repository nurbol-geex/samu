...
const ZendeskMessaging = NativeModules.ZendeskMessaging ? NativeModules.ZendeskMessaging : new Proxy({}, {
  get() {
 ...
 */
export function openMessagingView() {
 ...
 */
export function sendPageViewEvent(event) {
 ...
 */
export function setConversationFields(fields) {
 ...
 */
export function clearConversationFields() {
 ...
 */
export function setConversationTags(tags) {
 ...
 * @see iOS {@link https://developer.zendesk.com/documentation/zendesk-web-widget-sdks/sdks/ios/advanced_integration/#set-conversation-tags}
 */
export function clearConversationTags() {
...
export function handleNotification(remoteMessage) {
  return Platform.OS === 'android' ? ZendeskMessaging.handleNotification(remoteMessage) : Promise.resolve('UNKNOWN');
}
